  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_profile as @user_profile" do
        ...
        post :create, {:user_profile => {  }}, valid_session
        assigns(:user_profile).should be_a_new(UserProfile)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested user_profile" do
        ...
        UserProfile.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => user_profile.to_param, :user_profile => { "these" => "params" }}, valid_session
      end
